...
const cardVariants = cva(
  'rounded-lg transition-all duration-200',
  {
    variants: {
      variant: {
        // Clean default card - Anthropic-inspired
        default:
        ...
        outline:
          'bg-background border border-border text-foreground hover:border-muted-foreground/20',

        // Flat minimal card
        flat:
          'bg-muted/30 text-foreground border-0',
      },
    },
    defaultVariants: {
      variant: 'default',
